...
uint64_t adventDay25P12024(std::ifstream& input)
{
    uint64_t score = 0;
...
uint64_t adventDay25P22024(std::ifstream& input)
{
    uint64_t score = 0;

    paintAdventCalendar2024();
    std::cout << std::endl;
    std::cout << "        Happy Advent of Code 2024!" << std::endl;
