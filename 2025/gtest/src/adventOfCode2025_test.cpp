...
TEST(AdventOfCode2025, advOcodeD_05)
{
    ...
    EXPECT_EQ(3, launchProblem[FUNCTIONNAME1](inputFile1));
    EXPECT_EQ(14, launchProblem[FUNCTIONNAME2](inputFile2));
}
...
TEST(AdventOfCode2025, advOcodeD_06)
{
    ...
    EXPECT_EQ(4277556, launchProblem[FUNCTIONNAME1](inputFile1));
    EXPECT_EQ(3263827, launchProblem[FUNCTIONNAME2](inputFile2));
}
...
TEST(AdventOfCode2025, advOcodeD_08)
{
    ...
    EXPECT_EQ(20, launchProblem[FUNCTIONNAME1](inputFile1));
    EXPECT_EQ(25272, launchProblem[FUNCTIONNAME2](inputFile2));
}
...
TEST(AdventOfCode2025, advOcodeD_09)
{
    ...
    EXPECT_EQ(50, launchProblem[FUNCTIONNAME1](inputFile1));
    EXPECT_EQ(24, launchProblem[FUNCTIONNAME2](inputFile2));
}
...
TEST(AdventOfCode2025, advOcodeD_10)
{
    ...
    EXPECT_EQ(33, launchProblem[FUNCTIONNAME2](inputFile2));
}
